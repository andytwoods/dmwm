...
class ZohoInfo(models.Model):
    ...
    Within_Gateway_cluster = models.CharField(max_length=5, choices=Within_Gateway_cluster_Choice, null=True,
                                              blank=True)
    ...
    Company_Generic_Email = models.EmailField(blank=True, null=True)
    ...
    Unqualified_type_Choice = models.CharField(max_length=5, choices=Unqualified_type_Choice, null=True, blank=True)
